...
[![Rust](https://img.shields.io/badge/Rust-00E676?style=for-the-badge&logo=rust&logoColor=E8F1F2&labelColor=1C1C1C)](https://rust-lang.org)
[![License](https://img.shields.io/badge/License-MIT-1B5E20?style=for-the-badge&labelColor=1C1C1C)](LICENSE)
[![CI](https://img.shields.io/github/actions/workflow/status/OriginalMHV/Pulse/ci.yml?style=for-the-badge&label=CI&labelColor=1C1C1C&color=00E676)](https://github.com/OriginalMHV/Pulse/actions)
...
| **Cost estimation** | Per-model pricing for Claude Sonnet/Opus and GPT models |
...
| Model | Input | Output |
|-------|-------|--------|
| Claude Sonnet 4/4.5 | $3/M tokens | $15/M tokens |
